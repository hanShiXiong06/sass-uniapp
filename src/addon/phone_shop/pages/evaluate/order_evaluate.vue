     ...
     <view class="bg-[#f8f8f8] min-h-screen" :style="themeColor()">
          <view class="px-[24rpx] py-[20rpx]">
               <template v-for="(item, index)  in info" :key="index">
                    <view class="bg-white py-[20rpx] px-[24rpx] mb-[20rpx] rounded-[16rpx]">
                         <view class="flex mb-[20rpx]">
                              ...
                              <view class="flex-1 flex flex-wrap ml-[20rpx]">
                                   <view>
                                        ...
                                        <view
                                             class="w-[404rpx] mt-[12rpx] truncate text-[#888] text-[24rpx] leading-[32rpx]">
                                             {{ item.sku_name }}
                                        </view>
                                   </view>
                         ...
                         <view
                              class="pt-[20rpx] flex items-center border-0 border-t-[2rpx] border-solid border-[#ebebec]">
                         ...
                         <view class="text-right text-[24rpx] text-[#888]">{{ form[index].content.length >= 200 ? 200 :
                              form[index].content.length }}/200</view>
          ...
          <u-tabbar :fixed="true" :placeholder="true" :safeAreaInsetBottom="true" zIndex="9999">
               <view class="flex items-center px-[30rpx] py-[10rpx] box-border  justify-between w-[100%]">
                    ...
                    <button
                         class="!w-[444rpx] !h-[80rpx] text-[32rpx] !m-0 leading-[80rpx] rounded-full text-white bg-[var(--primary-color)] remove-border"
