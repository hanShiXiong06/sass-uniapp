    ...
    <view :style="themeColor()">
        <view class="bg-page h-screen overflow-hidden flex flex-col" v-if="!loading">
            <view v-if="!info" class="flex-1 flex flex-col justify-center bg-[#fff]">
                <image class="overflow-hidden mx-auto w-[348rpx] h-[250rpx]"
                    :src="img('static/resource/images/system/login.png')" model="aspectFit" />
                <view class="text-[#999] text-[26rpx] font-400 text-center leading-[30rpx]">暂未登录</view>
                <button shape="circle" plain="true"
                    class="!w-[220rpx] mt-[40rpx] text-[26rpx] !text-[#EF000C] !border-[#EF000C] leading-[62rpx] h-[66rpx] rounded-full"
                    @click="toLogin">去登录</button>
            </view>
            <view v-else-if="!cartList.length && !invalidList.length"
                class="flex-1 flex flex-col justify-center bg-[#fff]">
                <image class="overflow-hidden mx-auto w-[348rpx] h-[256rpx]"
                    :src="img('addon/phone_shop/cart-empty.png')" model="aspectFit" />
                <view class="text-[#999] text-[26rpx] font-400 text-center leading-[30rpx]">赶紧去逛逛, 购买心仪的商品吧</view>
                <button shape="circle" plain="true"
                    class="!min-w-[220rpx] mt-[40rpx] text-[26rpx] h-[66rpx] leading-[62rpx] !text-[#EF000C] !border-[#EF000C] rounded-full"
                    @click="redirect({ url: '/addon/phone_shop/pages/goods/list' })">去逛逛</button>
            </view>
            <block v-else>
                    ...
                    <scroll-view class="scroll-height box-border" :scroll-y="true">
                        <view class="py-[20rpx] sidebar-marign">
                            <view class="bg-[#fff] pb-[10rpx] box-border rounded-[16rpx]" v-if="cartList.length">
                                <view
                                    class="flex mx-[20rpx] justify-between items-center h-[76rpx] box-border font-400 text-[24rpx] mb-[10rpx] leading-[30rpx] border-0 border-b-[2rpx] border-solid border-[#F6F6F6]">
                                    ...
                                    <text @click="isEdit = !isEdit" class="text-[#666] text-[26rpx]">{{ isEdit ? '完成' :
                                        '管理' }}</text>
                                </view>
                                                ...
                                                <view class="flex px-[20rpx]">
                                                    ...
                                                    <view class="flex flex-1 flex-wrap ml-[20rpx] w-[410rpx]">
                                                        <view class="w-[100%] flex flex-col items-baseline">
                                                            <view
                                                                class="w-[406rpx] text-[#333] text-[28rpx] max-h-[80rpx] leading-[40rpx] multi-hidden font-400">
                                                                {{ item.goods.goods_name }}
                                                            </view>
                                                            <view
                                                                class="w-[406rpx] text-[#333] text-[20rpx] max-h-[80rpx] leading-[40rpx] multi-hidden font-400">
                                                                {{ item.goods.sub_title }}
                                                            </view>
                                                            <view
                                                                class="box-border max-w-[406rpx] mt-[4rpx] px-[14rpx] h-[36rpx] leading-[36rpx] truncate text-[#666] bg-[#F5F5F5] text-[22rpx] rounded-[20rpx]"
                                                        ...
                                                        <view class="flex justify-between items-end self-end w-[100%]">
                                                            <view
                                                                class="flex items-end text-[var(--price-text-color)] leading-[40rpx] price-font">
                                                                <view class="text-[var(--price-text-color)] price-font">
                                                                    ...
                                                                    <image class="h-[24rpx] ml-[6rpx]"
                                                                        ...
                                                                        :src="img('addon/phone_shop/discount.png')"
                                                                        mode="heightFix" />
                                                                </view>
                                                            </view>
                            ...
                            <view class="bg-[#fff] pb-[10rpx] box-border rounded-[16rpx] mt-[20rpx]"
                                v-if="invalidList.length">
                                <view
                                    class="flex px-[20rpx] justify-between items-center h-[79rpx] box-border font-400 text-[#303133] text-[24rpx] mb-[10rpx] leading-[30rpx] border-0 border-b-[2rpx] border-solid border-[#f6f6f6]">
                                    <text>共<text class="text-[var(--price-text-color)]">{{ invalidList.length
                                            }}</text>件失效商品</text>
                                ...
                                <view v-for="(item, index) in invalidList" class="py-[20rpx] overflow-hidden">
                                    <view class="flex px-[20rpx]">
                                        ...
                                        <view class="relative w-[168rpx] h-[168rpx]">
                                            ...
                                            <view v-if="item.goodsSku.stock == 0"
                                                class="absolute left-0 top-0  w-[168rpx] h-[168rpx]  leading-[168rpx] text-center "
                                        ...
                                        <view class="flex flex-1 flex-wrap ml-[20rpx] w-[410rpx]">
                                            <view class="w-[100%] flex flex-col items-baseline">
                                                <view
                                                    class="w-[406rpx] text-[#333] text-[28rpx] max-h-[80rpx] leading-[40rpx] font-400 multi-hidden">
                                                    {{ item.goods.goods_name }}
                                                </view>
                                                <view
                                                    class="w-[406rpx] text-[#333] text-[20rpx] max-h-[80rpx] leading-[40rpx] font-400 multi-hidden">
                                                    {{ item.goods.sub_title }}
                                                </view>
                                                <view
                                                    class="box-border max-w-[406rpx] mt-[4rpx] px-[14rpx] h-[36rpx] leading-[36rpx] truncate text-[#666] bg-[#F5F5F5] text-[22rpx] rounded-[20rpx]"
        ...
        <!--  #ifndef  H5 -->
        <view v-if="cartList.length"
            class="flex h-[100rpx] items-center bg-[#fff] fixed left-0 right-0 bottom-[100rpx] box-solid mb-ios justify-between">
            <view class="flex items-center pl-[30rpx]" @click="selectAll">
                <text
...
import { getCartGoodsList } from '@/addon/phone_shop/api/cart'
